...
from model.dataset import InjectDataProvider
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        ...
        if not args.interpolate:
            ...
            model.test(model_dir=args.model_dir, source_provider=source_provider,
                       embedding_ids=embedding_ids, save_dir=args.save_dir)
        else:
